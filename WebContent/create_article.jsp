				...
				<form action="CreateArticleServlet" method="get"> 
					...
					<div class="w3-card-4 w3-margin w3-white">
					  <div class="w3-container">
					    ...
					    <h3><b><input type="text" name="articleTitle" placeholder="Enter Title" style="background-color: white; border: 1px solid gray"></b></h3>
					  </div>
					
					  <div class="w3-container">
					     <p><textarea type="text" name="articleContent" placeholder="Enter Contents" rows="6" cols="100%" style="background-color: white; border: 1px solid gray"></textarea></p>
						 <div class="w3-row">
							<div class="w3-col m12 s12 w3-right-align">
								<p>
									...
									<button type="submit" class="w3-button w3-hover-green w3-padding-large w3-black w3-border"><b>Create</b></button>
								</p>
							</div>
					  	 </div>
					  </div>
